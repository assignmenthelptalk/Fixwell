  ...
  'handyman-cost-salisbury': {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'For well-defined, clearly scoped jobs, a fixed price is almost always preferable for the customer, as it removes cost uncertainty and gives you a firm figure to budget against. Good candidates for fixed pricing include: shelf installation (typically £40–£80 labour), furniture assembly (£30–£120 depending on complexity), fence panel replacement (£50–£120 per panel labour), TV mounting (£50–£80), and gutter clearing (£60–£120 for a standard house). For open-ended work where the scope is genuinely uncertain, such as general maintenance visits, investigation jobs, or multi-room painting, an hourly rate is more honest than a fixed price that will require adjustment. A professional handyman will advise which model suits your job, and should be willing to convert to fixed price once scope is confirmed.',
      },
      {
  ...
  'handyman-vs-tradesman': {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'Generally, yes, and significantly so. Handyman rates in Salisbury are £20–£40 per hour. Specialist plumbers typically charge £50–£90 per hour, and electricians £55–£100 per hour. For work that falls within handyman scope, using a professional handyman is the cost-effective choice with no reduction in quality or compliance.',
      },
      {
      ...
      },
      {
        ...
        a: 'Use this framework: Does it involve gas? You need a Gas Safe engineer. Does it involve a new electrical circuit, or electrical work in a kitchen or bathroom? You need a Part P electrician. Does it involve structural alteration to load-bearing elements? You may need a structural engineer. Everything else, including general repairs, maintenance, carpentry, painting, and plumbing repairs, is typically handyman scope. When in doubt, call a professional handyman first and describe the job.',
      },
    ],
  },
  ...
  'when-do-you-need-emergency-handyman': {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Active plumbing leaks (a burst or rapidly weeping pipe, a joint failure under a floor or within a wall, or an overflow that is not clearing) require immediate action before the professional arrives. First: turn off the water at the stopcock. In most UK homes this is under the kitchen sink or where the supply pipe enters the property through the floor or wall; if you do not know where yours is, find it before you need it. Second: turn off the boiler, as continued pressurisation against a burst pipe worsens the leak. Third: open cold taps to drain water from the system and reduce ongoing flow. Mop up as much surface water as you can to reduce secondary damage to floors, carpets, and subfloor. Signs that the source is not immediately visible (staining on ceilings, bubbling paint on walls, wet carpet without obvious cause) also warrant emergency investigation.",
      },
      {
