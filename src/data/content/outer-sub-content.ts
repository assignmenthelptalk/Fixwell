export const outerSubContent: Record<string, {
  ...
  'managing-rental-property-remotely-maintenance': {
    ...
    intro:
      'Managing a rental property from a distance, whether you live in another part of the UK or abroad, is entirely achievable, but it demands more deliberate systems than local landlords typically need. In England, remote landlords face the same legal maintenance obligations as any other landlord: Section 11 of the Landlord and Tenant Act 1985, the Homes (Fitness for Human Habitation) Act 2018, annual gas safety checks, five-yearly EICRs, and same-day emergency response expectations. The difference is logistics: without a physical presence in Salisbury, every one of those obligations depends on having the right people, processes, and tools in place before a problem arises. FixWell\'s <a href="/landlord-property-maintenance-salisbury">landlord property maintenance</a> service and <a href="/emergency-handyman-salisbury">emergency handyman cover</a> in Salisbury are specifically designed to give remote landlords the local presence they need.',
